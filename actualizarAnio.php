...
/*if(actualizarValidar($con, $conexion, $mesAnt, $mesAct))
    echo "Se actualizo tabla validar.";
else
    echo "Hubieron errores";

if(actualizarTiempos($con, $conexion, $mesAnt, $mesAct))
...
$eliminar = "delete from resultados where dia >= $mesAnt and dia <= $mesAct";
...
for($dia2 = new DateTime($mesAnt); $dia2->format("Ymd") >= $mesAct; $dia2->modify("-1 day")) {
    $d = $dia2->format("Ymd");
    echo $d . ", ";
    for($i = 0; $i < $cantidad; $i++){
        echo $f[$i] . ", ";
